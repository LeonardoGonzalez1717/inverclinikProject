...
<tr>
    ...
    <!-- mostramos rango_tallas solo si viene en el array, si no mostramos '—' -->
    <td><?= htmlspecialchars($row['rango_tallas'] ?? '—') ?></td>

    <!-- aseguramos que stock_actual siempre se muestre sin warnings -->
...
<?php else: ?>
<div class="no-data">No existen productos terminados registrados en inventario.</div>
<?php endif; ?>
